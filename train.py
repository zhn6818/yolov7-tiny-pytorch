...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=1,2 python train.py
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_path      = 'model_data/yolov7_tiny_backbone_weights.pth'
    # model_path      = 'model_data/yolov7_tiny_backbone_weights.pth'
    model_path      = 'logs/ep075-loss0.111-val_loss0.077.pth'
